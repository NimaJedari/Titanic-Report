# Titanic-Report
Conducted an end-to-end machine learning analysis on the Titanic passenger dataset to predict survival outcomes. The project covered the full data science workflow — including data cleaning, missing value imputation, exploratory data analysis, feature engineering, and predictive modeling.
